...
- **Prometheus & Grafana Monitoring**: Built-in `/metrics` endpoint with turnkey Docker Compose setup and rich pre-configured Grafana dashboard ([docs/monitoring_en.md](docs/monitoring.md))
